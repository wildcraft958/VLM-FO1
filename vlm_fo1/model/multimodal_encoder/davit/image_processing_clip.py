...
class CLIPImageProcessor(BaseImageProcessor):
    ...
    def __init__(
        ...
        candidate_sizes: List[int] = [384, 448, 512, 576, 640, 704, 768, 832, 896, 960, 1024, 1280, 1536, 1792, 2048], #[384, 448, 512, 576, 640, 704, 768, 832, 896, 960, 1024, 1088, 1152, 1216, 1280, 1344, 1408, 1472, 1536, 1600, 1664, 1728, 1792, 1856, 1920, 1984, 2048], #[384, 448, 512, 576, 640, 704, 768, 1024, 1280, 1536, 1792, 2048, 2304, 2560],  #[768, 1024, 1280, 1536, 1792, 2048]
    ...
    def resize(
        ...
        **kwargs,
        ...
        if self.resize_mode == "dynamic_square":
            w, h = image.shape[1], image.shape[0]
            area = w * h
            
            # 找到最接近的目标尺寸
            target_size = self.candidate_sizes[0]
            min_diff = float('inf')
            
            for cur_size in self.candidate_sizes:
                target_area = cur_size * cur_size
